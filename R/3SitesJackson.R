...
#'
#'
#' @description This function returns percent body mass estimates based on 3 sites skinfold measurements using the equations of Pollock (1978) and Jackson et al. (1980). Population Specifications: Both sexes; Male (aged 18-61) and Female (aged 18-55).
#'
#'
