...
#'
#'
#' @description This function returns percent body mass estimates based on 4 sites skinfold measurements using the equations of Durnin and Womersley (1974). Population Specifications: Adults (both sexes) non athletes from UK; Male (aged 17 - 72) and Female (aged 16 - 68).
#'
#'
