...
#'
#'
#' @description This function returns percent body mass estimates based on 2 sites skinfold measurements using the equations of Slaughter et al. (1988). Population Specifications: American black and white boys (aged 8 - 18) around maturation groups (Tanner Scale, 1962). American girls (aged 8 - 18).
#'
#'
